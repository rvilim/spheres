...
def solve(n_piles, n_cubes, diophantine=None):
    ...
    # Convert assigned_piles to tuple of integers for init_pos since tuples are immutable sequences
    assigned_piles:list[int] = [70368744177664, 35184372088832, 17592186044416, 8796093022208, 4398046511104, 0, 0, 0]
    ...
    for pile_idx in range(n_piles):
        print(pile_idx, assigned_pile.shape)
